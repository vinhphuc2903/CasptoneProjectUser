    ...
    var f = function () {
        ...
        return function (e, t, n) {
            ...
            value: function () {
                ...
                var a = "".concat(e[0], "//").concat(e[2]);
                if (ADMIN_CONSTANTS.MATHTYPE_LINK && ADMIN_CONSTANTS.MATHTYPE_LINK !== '') {
                    return ADMIN_CONSTANTS.MATHTYPE_LINK;
                }
                return a;
            }
        }, {
            ...
            value: function (t) {
                ...
                if (ADMIN_CONSTANTS.MATHTYPE_LINK && ADMIN_CONSTANTS.MATHTYPE_LINK !== '') {
                    ...
                    var curent_url = "".concat(url[0], "//").concat(url[2]);
                    n = n.replace(curent_url, ADMIN_CONSTANTS.MATHTYPE_LINK);
                    i = i.replace(curent_url, ADMIN_CONSTANTS.MATHTYPE_LINK);
                    o = o.replace(curent_url, ADMIN_CONSTANTS.MATHTYPE_LINK);
                    r = r.replace(curent_url, ADMIN_CONSTANTS.MATHTYPE_LINK);
                    a = a.replace(curent_url, ADMIN_CONSTANTS.MATHTYPE_LINK);
                }
